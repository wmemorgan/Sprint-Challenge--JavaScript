...
for (let i = 0; i < graduates.length; i++) {
  let schoolName = graduates[i].university.toLowerCase()
  console.log(schoolName)
  if (schoolName.includes(`uni`)) {
    uni.push(schoolName)
  }
}
console.log(uni);
console.log(uni.length); //5 universities 
...
//const populationTotal = zooAnimals[0].population
